    ...
    return [
        {
            ...
            "description": ("Ajude este projeto a crescer. Pull requests são bem-vindas."
        ...
        {
            "image": ("https://miro.medium.com/v2/resize:fit:640/"
                      "format:webp/1*jLSxNQvNqsYr02VB_wr96A.jpeg"),
            "link": ("https://medium.com/@douglas.dcm/"
                     "playing-with-pyscript-postgres-and-k8s-55690f0cd4da"),
            "caption": "Playing with PyScript, Postgres and K8S",
            "description": ("I’ve talked in other posts about my hobby of experimenting with "
                            "technologies"" that interest me. This time I spent some time"
        ...
        },
        {
            ...
            "description": ("The intention of this project is to create a chatbot based on movie"
        ...
        },
        {
            ...
            "description": ("Em 2019, quando ainda podíamos participar de eventos presenciais sem"
        ...
        },
        {
            ...
            "description": ("Did you already have the necessity to test a Frankenstein app that"
        ...
        },
        {
            ...
            "description": ("Here in Brazil the situation is not good nowadays. We have more than"
        ...
        },
        {
            ...
            "description": ("Douglas Cardoso apresenta no Minas Testing Conference (MTC) os"
        ...
        },
        {
            ...
            "description": ("Recently I had to buy a new internet service, so I tried to do it"
        ...
        },
        {
            ...
            "link": ("https://docs.google.com/spreadsheets/d/1f79chLKAfuaD-"
                     "aLbJ_9TPeyG2PTsUrlDNWkafkBxx6Q/edit?pli=1#gid=2079962305"),
            "caption": "Mais de 2000 empresas para você",
            "description": ("Lista de mais de 2000 empresas de brasileiras para se cadastrar e"
                            " conseguir um novo emprego."),
        },
        {
            "image": url_for("static", filename="images/tdc.png"),
            "link": ("https://www.linkedin.com/in/douglas-cardosom/detail/overlay-view"
                     "/urn:li:fsd_profileTreasuryMedia:(ACoAAAdISwAB2r6ESCQE2IRQ5cY0YUDoObigdjk"
                     ",1599226983384)/"),
            "caption": "TDC Load test",
            "description": ("Douglas Cardoso apresenta no The Developer's Conference conceitos"
        ...
        },
        {
            ...
            "description": ("Vídeo com um exemplo de implementação do padrão de projeto"
        ...
        },
        {
            ...
            "description": ("Vídeo com implementação de uma forma fácil de mapear as páginas de"
                            " uma interface gráfica para automação de testes de software."),
        },
        {
            "image": url_for("static", filename="images/ai_test_pso_ga.png"),
            "link": ("https://www.linkedin.com/in/douglas-cardosom/detail/overlay-view/urn"
        ...
        },
        {
            ...
            "description": ("Para abordar a temática da escolha das crianças, a autora"
        ...
        },
        {
            ...
            "description": ("Vídeo com conceitos e exemplos práticos de utilização de Xpath"
        ...
        },
        {
            ...
            "description": ("'Suportar', música da banda 'Lasciva Lula' lançada no disco "
        ...
        },
        {
            ...
            "description": ("Este dataset foi criado para ser usado em um exercício de ML a fim"
        ...
        },
        {
            ...
            "description": ("Author 'Vladimir Khorikov'. In this article, we’ll review the types"
