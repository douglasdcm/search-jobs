...
class Vagas:
    ...
    def _scroll_to_next_button(self, by_type, locator):
        by_type = By.XPATH
        locator = '//i[contains(@class,"angle right")]'
        self._base_objects.scrool_to_element(by_type, locator)
    ...
    def check_next_page_available(self):
        by_type = By.XPATH
        locator = '//i[contains(@class,"angle right")]'
        return self._base_objects.is_element_visible(by_type, locator)
